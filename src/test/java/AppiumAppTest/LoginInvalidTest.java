...
public class LoginInvalidTest extends BaseClass{
    ...
    public void testNoDataLogin() throws InterruptedException {
        test = TestSuite.createTest("Prueba Login Válido datos erroneos", "Probar el login con credenciales inválidas");
        test.log(Status.INFO, "Comenzando caso de prueba de login invalido");
        ...
        driver.findElement(By.id("cl.yapo:id/password")).sendKeys("sfsdf4565");
